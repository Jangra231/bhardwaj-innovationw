...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-slate-300 border-t border-slate-900 pt-6 pb-3">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 pb-5 border-b border-slate-900 text-left">
        <div className="space-y-3">
          ...
          <div className="flex gap-3">
            <a
              href="#"
              className="p-2 bg-slate-900 hover:bg-sky-600 rounded-lg text-slate-400 hover:text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-sky-500/20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400 transition-all duration-200"
            >
        ...
        <div className="space-y-3">
          <h4 className="text-sm font-bold text-white uppercase tracking-wider border-b border-slate-900 pb-1.5">
            Quick Navigation
          </h4>
          <ul className="space-y-1.5">
            {quickLinks.map((link, idx) => (
              <li key={idx}>
                <Link
                  href={link.href}
                  className="text-xs text-slate-400 hover:text-sky-400 hover:translate-x-1 transition-all duration-200 cursor-pointer text-left font-light flex items-center gap-1.5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400"
                >
        ...
        <div className="space-y-3">
          ...
          <h4 className="pt-3 text-sm font-bold text-white uppercase tracking-wider border-b border-slate-900 pb-1.5">
            Software Products
          </h4>
          <ul className="space-y-1.5">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-3 flex flex-col md:flex-row items-center justify-between text-slate-500 text-[10px] uppercase font-semibold tracking-wider">
